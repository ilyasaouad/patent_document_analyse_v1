"""
Main entry point for the Patent Document Text Extract Service.
...
from app.mineru_wrapper import MinerUWrapper
from config.settings import settings

app = FastAPI(
    title="Patent Document Text Extract Service",
...
@app.get("/")
async def root():
    return {"message": "Patent Document Text Extract Service", "status": "running"}
